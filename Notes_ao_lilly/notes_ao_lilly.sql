WITH notes AS (
    ...
    INNER JOIN udm_staging.patientlist_lilly_all c on c.ndid = e.chartid
    UNION ALL
    SELECT 
        e.patientid, 
        e.chartid, 
    ...
    INNER JOIN udm_staging.patientlist_lilly_all d on d.ndid = e.chartid
    UNION ALL
    SELECT 
        e.patientid, 
        e.chartid, 
    ...
    INNER JOIN udm_staging.patientlist_lilly_all f on f.ndid = e.chartid
    UNION ALL
    SELECT 
        e.patientid, 
        e.chartid, 
    ...
    INNER JOIN udm_staging.patientlist_lilly_all g on g.ndid = e.chartid
)
SELECT DISTINCT
