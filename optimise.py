...
Usage:
    /Users/shubham/miniconda3/envs/deid/bin/python run_udm_join.py
"""
...
DEST_TABLE       = "suven.notes_part1_dent_new"
STAGING_TABLE    = "staging.nw_testing_notes_n_up_1"
CHECKPOINT_TABLE = "staging.etl_checkpoint_3_n_up_1"
...
def setup_tables():
    ...
    cur.execute(f"SELECT COUNT(*) FROM information_schema.tables WHERE table_schema = %s AND table_name = %s",
...
def main():
    ...
    # Setup tables and compute batches
